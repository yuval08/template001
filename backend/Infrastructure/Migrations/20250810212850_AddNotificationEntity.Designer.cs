...
namespace IntranetStarter.Infrastructure.Migrations
{
    ...
    [Migration("20250810212850_AddNotificationEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IntranetStarter.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IntranetStarter.Domain.Entities.PendingInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IntranetStarter.Domain.Entities.Notification", b =>
                {
                    b.HasOne("IntranetStarter.Domain.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("IntranetStarter.Domain.Entities.PendingInvitation", b =>
                {
                    b.HasOne("IntranetStarter.Domain.Entities.User", "InvitedBy")
                        .WithMany()
